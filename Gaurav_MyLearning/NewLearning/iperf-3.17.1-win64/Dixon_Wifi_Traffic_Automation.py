...
if __name__ == "__main__":
    ...
    target_ssid = input(Fore.YELLOW + "Enter your SSID like {Airtel_Zerotouch_2.4G_DXB_6_PP}: " + Style.RESET_ALL) or "Airtel_Zerotouch_2.4G_DXB_6_PP"
    password = input(Fore.YELLOW + "Enter your SSID Password: " + Style.RESET_ALL) or "Airtel@123"
