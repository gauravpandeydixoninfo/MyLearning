...
if __name__ == '__main__':
    ...
    # Get the log files name from user
    file_name = input(Fore.YELLOW + "Enter your first filename : " + Style.RESET_ALL) or "log_2024-10-23_14-33-47_Airtel_Zerotouch_5G_ZX_6_GP.txt"
    first_file_name, first_file_path = get_file_name_and_path(file_name)
    
    file_name = input(Fore.YELLOW + "Enter your second filename : " + Style.RESET_ALL) or "log_2024-11-12_10-28-04_Airtel_Zerotouch_2.4G_DXB_6_PP.txt"    
