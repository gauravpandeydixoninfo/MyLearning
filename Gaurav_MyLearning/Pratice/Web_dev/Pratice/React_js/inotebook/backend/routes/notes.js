...
// Route 3: Update an existing Note using: POST "/api/auth/updatenote". Login require
...
// Route 4: delelte an existing Note using: POST "/api/auth/updatenote". Login require
