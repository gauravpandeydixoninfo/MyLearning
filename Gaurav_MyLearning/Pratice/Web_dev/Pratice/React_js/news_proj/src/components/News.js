...
export default class News extends Component {
  ...
  handleNextClick= async ()=>{
    ...
    fetch(`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5a0e740334694b1ea36ba2a1b410c030&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`)
      ...
      console.log("on next click this.state.page ="+ this.state.page)}
    // let url= `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=spo&apiKey=5a0e740334694b1ea36ba2a1b410c030&page=${this.state.page + 1}`;
    // this.setState({
